                    ...
                    <form action="{{ route('organizer.events.update', $event) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                            ...
                            <div class="flex">
                                ...
                                <div class="ml-3">
                                    <p class="text-sm text-yellow-700">
                                        Note: Editing an event will immediately change its status back to <strong>Pending</strong>. An Admin must re-approve it before it becomes visible to the public again.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="date" class="block mt-1 w-full" type="date" name="date" :value="old('date', $event->date->format('Y-m-d'))" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="time" class="block mt-1 w-full" type="time" name="time" :value="old('time', $event->time->format('H:i'))" required />
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="registration_start" class="block mt-1 w-full" type="datetime-local" name="registration_start" :value="old('registration_start', $event->registration_start->format('Y-m-d\TH:i'))" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="registration_end" class="block mt-1 w-full" type="datetime-local" name="registration_end" :value="old('registration_end', $event->registration_end->format('Y-m-d\TH:i'))" required />
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="max_participants" class="block mt-1 w-full" type="number" min="1" name="max_participants" :value="old('max_participants', $event->max_participants)" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="registration_fee" class="block mt-1 w-full" type="number" step="0.01" min="0" name="registration_fee" :value="old('registration_fee', $event->registration_fee)" placeholder="Leave empty for free" />
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-sm text-gray-500">Max size: 2MB. Format: JPG, PNG. Leave empty to keep the current image.</p>

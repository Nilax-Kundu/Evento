    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('home') }}" class="flex items-center space-x-2">
                        ...
                        <span class="text-xl font-semibold tracking-tight text-slate-900"><span class="text-teal-700">E</span>vento</span>
                    </a>
                </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                @else
                    <div class="space-x-4">
                        <a href="{{ route('login') }}" class="text-slate-500 hover:text-slate-700">Log in</a>
                        <a href="{{ route('register') }}" class="text-white bg-teal-700 hover:bg-teal-600 px-4 py-2 rounded-md font-medium text-sm transition">Register</a>
                    </div>
                @endauth
            </div>
